...
const Card = ({data}) => {
  ...
  return (
    <section className='card blur-box rounded-lg'>
    <Link to={"/"} className=" flex gap-4 flex-col sm:flex-row items-start">
    <img src={companyLogo} alt=""/>
    <div>
    <h4 className='text-white mb-1'>{companyName}</h4>
    <h3 className='text-ly text-lg font-semibold mb-2'>{jobTitle}</h3>
    <div className='text-ly text-base flex flex-wrap gap-2 mb-2'>
